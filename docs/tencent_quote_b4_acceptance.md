...
当前开发暂停，等待上传 GitHub 并首次运行 Python 3.10/3.13 远程离线 CI。P1-04
Eastmoney CN Profile observed Fixture 在 2026-07-25 的第二次独立受控观察中仍未形成；
任何未来在线观察必须重新单独授权。暂停期间不启动新的在线观察、Provider 功能或腾讯
正式接入设计。
